...
from src.agents.data_structures.data_classes import (
    PatchingTask,
    PatchingResponse,
    TestingTask,
    TestingResponse,
...
from src.agents.helpers import agent_helpers as helpers
from src.agents.data_structures.dicts import BugDict, ContextDict
from src.agents.helpers import patch_utils
from src.agents.helpers.function_call_schema import create_function_call_schema
from src.agents.helpers import context_retrieval_functions as functions

from src.tools.test_suites import test_suites as ts
...
class ContextRetrievalAgent(RoutedAgent):
    ...
    def execute_functions(self, function_name: str, file_path: str, function_args: dict = None):
        ...
        if start_line is not None and end_line is not None:
            try:
                from src.tools.context_retrieval.parsing_retrieval_funcs import tree_sitter_utils
